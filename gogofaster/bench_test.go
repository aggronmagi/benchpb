...
func generateSameValue(value *gopb_msg.FieldTestMessage) (
	...
	gogofasterpb *gogofaster_msg.FieldTestMessage,
	...
	err = json.Unmarshal(data, gogofasterpb)
	if err != nil {
		panic(err)
	}
	return
...
func equal(t *testing.T, v1 *gopb_msg.FieldTestMessage, v2 *gogofaster_msg.FieldTestMessage) {
...
func BenchmarkVS(b *testing.B) {
	...
	for _, v := range bd {
		...
		b.Run(v.name+"gogofaster-marshal", func(b *testing.B) {
			for i := 0; i < b.N; i++ {
				proto.Marshal(v2)
			}
		})
		...
		b.Run(v.name+"gogofaster-unmarshal", func(b *testing.B) {
			for i := 0; i < b.N; i++ {
				v2 = &gogofaster_msg.FieldTestMessage{}
				proto.Unmarshal(d2, v2)
			}
		})
		// b.Run(v.name+"gogofasterpb-unmarshal-cross", func(b *testing.B) {
		// 	for i := 0; i < b.N; i++ {
		// 		v2 = &gogofaster_msg.FieldTestMessage{}
